...
extern "C" {
    ...
    pub fn crypto_core_hsalsa20(out: *mut u8, in_: *const u8, k: *const u8, c: *const u8) -> c_int;
}


#[test]
fn test_crypto_core_hsalsa20_outputbytes() {
    assert!(unsafe { crypto_core_hsalsa20_outputbytes() as usize } ==
            crypto_core_hsalsa20_OUTPUTBYTES)
}
#[test]
fn test_crypto_core_hsalsa20_inputbytes() {
    assert!(unsafe { crypto_core_hsalsa20_inputbytes() as usize } ==
...
fn test_crypto_core_hsalsa20_constbytes() {
    assert!(unsafe { crypto_core_hsalsa20_constbytes() as usize } ==
