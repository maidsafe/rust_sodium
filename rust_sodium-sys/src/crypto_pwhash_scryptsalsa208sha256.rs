...
pub const crypto_pwhash_scryptsalsa208sha256_STRPREFIX: *const c_char = (b"$7$\0" as *const u8) as
                                                                        *const c_char;
pub const crypto_pwhash_scryptsalsa208sha256_OPSLIMIT_INTERACTIVE: usize = 0x8_0000;
pub const crypto_pwhash_scryptsalsa208sha256_MEMLIMIT_INTERACTIVE: usize = 0x100_0000;
pub const crypto_pwhash_scryptsalsa208sha256_OPSLIMIT_SENSITIVE: usize = 0x200_0000;
pub const crypto_pwhash_scryptsalsa208sha256_MEMLIMIT_SENSITIVE: usize = 0x4000_0000;
...
extern "C" {
    ...
    pub fn crypto_pwhash_scryptsalsa208sha256(out: *mut u8,
                                              outlen: c_ulonglong,
                                              passwd: *const c_char,
...
fn test_crypto_pwhash_scryptsalsa208sha256_saltbytes() {
    assert!(unsafe { crypto_pwhash_scryptsalsa208sha256_saltbytes() as usize } ==
            crypto_pwhash_scryptsalsa208sha256_SALTBYTES)
}
#[test]
fn test_crypto_pwhash_scryptsalsa208sha256_strbytes() {
    assert!(unsafe { crypto_pwhash_scryptsalsa208sha256_strbytes() as usize } ==
            crypto_pwhash_scryptsalsa208sha256_STRBYTES)
}
#[test]
fn test_crypto_pwhash_scryptsalsa208sha256_opslimit_interactive() {
    assert!(unsafe { crypto_pwhash_scryptsalsa208sha256_opslimit_interactive() as usize } ==
            crypto_pwhash_scryptsalsa208sha256_OPSLIMIT_INTERACTIVE)
}
#[test]
fn test_crypto_pwhash_scryptsalsa208sha256_memlimit_interactive() {
    assert!(unsafe { crypto_pwhash_scryptsalsa208sha256_memlimit_interactive() as usize } ==
            crypto_pwhash_scryptsalsa208sha256_MEMLIMIT_INTERACTIVE)
}
#[test]
fn test_crypto_pwhash_scryptsalsa208sha256_opslimit_sensitive() {
    assert!(unsafe { crypto_pwhash_scryptsalsa208sha256_opslimit_sensitive() as usize } ==
            crypto_pwhash_scryptsalsa208sha256_OPSLIMIT_SENSITIVE)
}
#[test]
fn test_crypto_pwhash_scryptsalsa208sha256_memlimit_sensitive() {
    assert!(unsafe { crypto_pwhash_scryptsalsa208sha256_memlimit_sensitive() as usize } ==
...
fn test_crypto_pwhash_scryptsalsa208sha256_ll_1() {
    ...
    let p = 1;
    let mut buf = [0u8; 64];
    let expected = [0x77, 0xd6, 0x57, 0x62, 0x38, 0x65, 0x7b, 0x20, 0x3b, 0x19, 0xca, 0x42, 0xc1,
...
fn test_crypto_pwhash_scryptsalsa208sha256_ll_2() {
    ...
    let p = 16;
    let mut buf = [0u8; 64];
    let expected = [0xfd, 0xba, 0xbe, 0x1c, 0x9d, 0x34, 0x72, 0x00, 0x78, 0x56, 0xe7, 0x19, 0x0d,
...
fn test_crypto_pwhash_scryptsalsa208sha256_ll_3() {
    ...
    let p = 1;
    let mut buf = [0u8; 64];
    let expected = [0x70, 0x23, 0xbd, 0xcb, 0x3a, 0xfd, 0x73, 0x48, 0x46, 0x1c, 0x06, 0xcd, 0x81,
...
fn test_crypto_pwhash_scryptsalsa208sha256_ll_4() {
    ...
    let p = 1;
    let mut buf = [0u8; 64];
    let expected = [0x21, 0x01, 0xcb, 0x9b, 0x6a, 0x51, 0x1a, 0xae, 0xad, 0xdb, 0xbe, 0x09, 0xcf,
