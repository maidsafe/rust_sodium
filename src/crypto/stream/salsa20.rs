...
use ffi::{crypto_stream_salsa20, crypto_stream_salsa20_xor, crypto_stream_salsa20_KEYBYTES,
...
mod test {
    ...
    fn test_vector_1() {
        ...
        let digest_expected = [0x66, 0x2b, 0x9d, 0x0e, 0x34, 0x63, 0x02, 0x91, 0x56, 0x06, 0x9b,
                               0x12, 0xf9, 0x18, 0x69, 0x1a, 0x98, 0xf7, 0xdf, 0xb2, 0xca, 0x03,
                               0x93, 0xc9, 0x6b, 0xbf, 0xc6, 0xb1, 0xfb, 0xd6, 0x30, 0xa2];
